  ...
  <div class="bg-white py-24 sm:py-32">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div
        ...
        <div>
          <div class="  text-gray-700 lg:max-w-lg">

            <h1 class="mt-2 text-3xl font-bold  text-gray-900 sm:text-4xl">More than 20 years of architecting data.</h1>
            <div class="max-w-xl">
              <p class="mt-6 text-black ">Faucibus commodo massa rhoncus, volutpat. Dignissim sed eget risus enim. Mattis
                mauris
              ...
              <p class="mt-8 text-black">Et vitae blandit facilisi magna lacus commodo. Vitae sapien duis odio id et. Id
                blandit
          ...
          <div class="mt-10 flex">
            <a href="/about" class="text-base font-semibold leading-7 text-slate-900">Learn more about me <span
